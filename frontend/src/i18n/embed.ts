...
const messages = {
  "vi-VN": {
    ...
    "chat": {
      ...
      "refreshSuggestedQuestions": "Đổi nhóm khác",
      "referencesWebCount": "Đã tham khảo {count} trang web",
      "preparingAnswer": "Đang chuẩn bị câu trả lời…",
      "connectingModelAndGeneratingAnswer": "Đang kết nối mô hình và sinh câu trả lời…",
      "modelStillResponding": "Mô hình phản hồi chậm, vẫn đang chờ…",
      ...
      "attachmentReady": "Đã phân tích xong",
      "attachmentUploadFailed": "Tải tệp đính kèm thất bại",
      "attachmentParseFailed": "Phân tích tệp đính kèm thất bại",
      "attachmentStillProcessing": "Tệp {name} vẫn đang được phân tích, vui lòng chờ",
      "attachmentParseTimeout": "Phân tích tệp đính kèm quá lâu, vui lòng thử lại sau",
    },
    "common": {
      "loading": "Đang tải...",
      "confirm": "Xác nhận",
    ...
    "agentStream": {
      "toolApproval": {
        ...
        "titleWithTarget": "Duyệt thủ công · {service} › {tool}",
        "resolvedApproved": "Đã duyệt · {target}",
        "resolvedRejected": "Đã từ chối · {target}",
        "countdownShort": "{seconds}s",
      },
      "mcpOAuth": {
        "banner": "Dịch vụ MCP này cần được ủy quyền OAuth mới gọi được",
        "waiting": "Chờ ủy quyền · {target}",
        "waitingStatus": "Chờ ủy quyền",
        "targetWithTool": "{service} › {tool}",
        "titleWithService": "Ủy quyền OAuth · {service}",
        "titleWithTool": "Ủy quyền OAuth · {service} › {tool}",
        "resolvedAuthorized": "Đã ủy quyền · {target}",
        "resolvedTimedOut": "Hết thời gian ủy quyền · {target}",
        "resolvedCanceled": "Đã bỏ qua · {target}",
        "desc": "Bấm ủy quyền sẽ mở cửa sổ mới để đăng nhập; ủy quyền xong sẽ tự động tiếp tục lần gọi công cụ này.",
        "authorize": "Đi ủy quyền",
        "skip": "Bỏ qua",
        "countdown": "Còn khoảng {seconds} giây",
        "countdownShort": "{seconds}s",
        ...
        "canceledTag": "Đã hủy",
        "authorizedToast": "Ủy quyền thành công, đang tiếp tục",
        "startFailed": "Khởi tạo ủy quyền thất bại",
        "resumeFailed": "Khôi phục thực thi thất bại, vui lòng thử lại",
      ...
      "search": {
        ...
        "foundMixedResults": "Tìm thấy {count} kết quả ({docCount} tài liệu, {webCount} trang web)",
      },
      "grepResults": {
      ...
      "attachmentParsing": {
        ...
        "parsedWithSkipped": "Đã phân tích {parsed} tệp đính kèm, bỏ qua {skipped} tệp chưa xong",
        "noneReady": "Không có tệp đính kèm đã phân tích nào khả dụng"
      },
      "ragPipeline": {
      ...
      "toolStatus": {
        ...
        "searchMixed": "Tìm kho tri thức và web",
