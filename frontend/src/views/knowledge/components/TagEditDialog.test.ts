...
// Fork Dương Sinh bỏ zh-CN, dùng vi-VN làm ngôn ngữ chính (xem 04-nhat-ky-tuy-bien.md C4).
const viVN = readFileSync(new URL('../../../i18n/locales/vi-VN.ts', import.meta.url), 'utf8')
...
test('defines the short dialog heading in every supported locale', () => {
  for (const locale of [viVN, enUS, koKR, ruRU]) {
