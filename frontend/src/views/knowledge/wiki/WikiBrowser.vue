          ...
          <div class="wiki-reader-inner">
            <template v-if="selectedPage">
                  ...
                  <div class="wiki-reader-aside">
                    <div class="wiki-reader-actions" role="toolbar"
                      ...
                      <template v-else>
                        ...
                        <!-- Lớp cờ (fork): tạo bài giảng cờ từ trang wiki đang xem.
                             0.7.2 chuyển hàng meta cũ thành thanh nút icon, nên nút
                             này theo về đây thay vì nằm dưới tiêu đề như trước. -->
                        <t-tooltip :content="$t('knowledgeEditor.wikiBrowser.createLesson')" placement="top">
                          <button type="button" class="wiki-action-btn"
                            :aria-label="$t('knowledgeEditor.wikiBrowser.createLesson')"
              ...
              <!-- Content. Render theo đoạn để nhúng bàn cờ tương tác ngay tại
                   ...
                   như cũ. -->
              <div v-if="!editingPage" ref="readerBodyRef" class="wiki-reader-body"
